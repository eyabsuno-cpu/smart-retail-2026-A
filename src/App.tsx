...
export default function App() {
  ...
  const [exportingState, setExportingState] = useState<'idle' | 'downloading' | 'success'>('idle');
            ...
            <AnimatePresence mode="wait">
              {processingSubStep === 'downloading' ? (
                <motion.div
                  ...
                  className="space-y-8"
                >
                  <div className="w-24 h-24 bg-[#0055ff] rounded-full flex items-center justify-center text-white mx-auto mb-8">
                    <Upload size={40} />
                  </div>
          ...
          >
            ...
            <div className="pt-8">
              <button 
                ...
                className="bg-[#0055ff] text-white px-12 py-4 rounded-xl font-bold text-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20 active:scale-[0.98] flex items-center gap-3 mx-auto"
              >
      ...
      <div className="flex h-screen bg-[#f4f7fa] font-sans text-slate-900 overflow-hidden">
        ...
        <aside className="w-64 bg-white border-r border-slate-200 flex flex-col shrink-0">
          ...
          <nav className="flex-1 px-4 space-y-2">
            {[
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${
                  item.active 
                    ? 'bg-[#f0f7ff] text-[#0055ff] border-r-4 border-[#0055ff] rounded-r-none' 
            ...
            {[
              { icon: UploadCloud, label: 'External Data' },
            ].map((item, i) => (
              <button
                key={i}
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0">
            <h1 className="text-2xl font-bold text-slate-800">Système de Prévision des Ventes</h1>
            ...
            <div className="flex items-center gap-6">
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-10 pr-10 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm w-64 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                />
                <Maximize2 className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400" size={16} />
              </div>
                          ...
                          <>
                            ...
                            >
                              ...
                              <div className="mt-4 pt-4 border-t border-slate-100 flex justify-end">
                                <button 
                                  onClick={() => setShowCalendar(false)}
                                  className="px-4 py-2 bg-[#0055ff] text-white text-xs font-bold rounded-lg hover:bg-[#0044ee] transition-colors"
                                >
                                  Appliquer
                                </button>
                              </div>
                ...
                <div className="h-[300px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={CHART_DATA}>
                      ...
                      <Line type="monotone" dataKey="n" stroke="#0055ff" strokeWidth={2} dot={false} />
                      ...
                      <tr key={i} className="group">
                        ...
                        <td className="py-4 text-right">
                          <button 
                            ...
                            className="px-6 py-2 bg-[#0055ff] text-white text-[10px] font-bold rounded-lg hover:bg-blue-700 transition-colors uppercase"
                          >
                            Analyse
                          </button>
                        </td>
            ...
            <>
              ...
              >
                <div className="p-8 border-b border-slate-100 flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <div className="w-1 h-6 bg-[#0055ff] rounded-full" />
                ...
                <div className="p-8">
                  <button className="w-full py-4 bg-[#0055ff] text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20 active:scale-[0.98]">
  ...
  if (state.step === 'analysis-detail') {
    return (
      <div className="flex h-screen bg-[#F8FBFF]/50 font-sans text-slate-900 overflow-hidden">
        {/* Sidebar */}
        <aside className="w-[310px] bg-white border-r border-[#D9D9D9] flex flex-col shrink-0">
          <div className="p-8 flex items-center gap-4 mb-4">
            <div className="w-[52px] h-[52px] bg-black flex items-center justify-center relative">
               <div className="w-[17px] h-[22px] bg-[#1677FF]"></div>
            </div>
          ...
          <nav className="flex-1 flex flex-col">
            <div className="flex-1 space-y-1">
              <button
                onClick={() => setState(prev => ({ ...prev, step: 'dashboard' }))}
                className="w-full flex items-center gap-4 px-8 py-8 bg-[#F8FCFF] text-[#1677FF] border-r-4 border-[#1677FF] transition-all"
              >
                <LayoutDashboard size={24} />
                <span className="text-[22px]">Dashboard</span>
              </button>
              
              <button className="w-full flex items-center gap-4 px-8 py-8 text-black hover:bg-slate-50 transition-all">
                <TrendingUp size={24} />
                <span className="text-[22px]">Forecasting Unit</span>
              </button>

              <button className="w-full flex items-center gap-4 px-8 py-8 text-black hover:bg-slate-50 transition-all">
                <Home size={24} />
                <span className="text-[22px]">Store Allocation</span>
              </button>

              <button className="w-full flex items-center gap-4 px-8 py-8 text-black hover:bg-slate-50 transition-all">
                <Link size={24} />
                <span className="text-[22px]">Supplier Connect</span>
              </button>

              <button className="w-full flex items-center gap-4 px-8 py-8 text-black hover:bg-slate-50 transition-all">
                <Cloud size={24} />
                <span className="text-[22px]">Weather Hub</span>
              </button>
            </div>
            ...
            <div className="border-t border-[#D9D9D9]">
              <button className="w-full flex items-center gap-4 px-8 py-8 text-black hover:bg-slate-50 transition-all">
                <UploadCloud size={24} />
                <span className="text-[22px]">External Data</span>
              </button>
            </div>
          </nav>
        </aside>
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-[#F8FBFF]/30">
          ...
          <header className="bg-white border-b border-[#D9D9D9] px-6 py-8 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-6">
              <button 
                onClick={() => setState(prev => ({ ...prev, step: 'dashboard' }))}
              ...
              <div className="flex items-center gap-6">
                ...
                />
                <div>
                  <h1 className="text-[38px] font-semibold text-black leading-tight">Jimmy Veste en laine et toile de soie</h1>
                  <div className="flex items-center gap-4 mt-2">
                    <span className="text-xl text-black/45">SKU: 859163YCUA21000</span>
                    <span className="text-xl text-black/45">Category: Summer 25 Veste</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center">
              <div className="px-6 border-r border-[#D9D9D9] text-right">
                <p className="text-base text-black/65 mb-2">Stock Actuel</p>
                <p className="text-[28.85px] font-semibold text-[#101828]">45 <span className="text-base font-normal text-black/45">unités</span></p>
              </div>
              <div className="px-6 text-right">
                <p className="text-base text-black/65 mb-2">Ventes Moy. Hebdo</p>
                <p className="text-[28.85px] font-semibold text-[#101828]">32 <span className="text-base font-normal text-black/45">unités/sem</span></p>
              </div>
            </div>
          </header>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
            <div className="grid grid-cols-12 gap-6">
              {/* Initial Forecast */}
              <div className="col-span-8 bg-[#F8FBFF] p-6 rounded-lg border border-[#BAE0FF] flex flex-col gap-8">
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-2 text-[#1677FF]">
                    <Target size={24} />
                    <span className="text-[22.44px] font-medium uppercase">PRÉVISION INITIALE</span>
                  </div>
                  <div className="flex items-center gap-2 px-2 py-2 bg-[#FFFBE6] rounded text-[#D48806]">
                    <AlertCircle size={24} />
                    <span className="text-xl font-semibold">Moyenne</span>
                  </div>
                </div>
                
                <div>
                  <div className="text-[48px] font-bold text-[#101828] leading-none">95</div>
                  <p className="text-xl text-black/45 mt-2">Unités</p>
                </div>

                <div className="grid grid-cols-3 gap-6">
                  <div className="bg-white p-4 rounded shadow-sm">
                    <p className="text-base text-black/65 mb-2">Ventes prévues</p>
                    <p className="text-[30px] font-semibold text-black">140</p>
                    <p className="text-[19.23px] text-[#389E0D] font-normal">+14% vs moy</p>
                  </div>
                  <div className="bg-white p-4 rounded shadow-sm">
                    <p className="text-base text-black/65 mb-2">Couverture</p>
                    <p className="text-[30px] font-semibold text-black">5J</p>
                    <p className="text-[19.23px] text-black/45 font-normal">avec commande</p>
                  </div>
                  <div className="bg-white p-4 rounded shadow-sm">
                    <p className="text-base text-black/65 mb-2">Risque</p>
                    <p className="text-[30px] font-semibold text-black">65%</p>
                    <p className="text-[19.23px] text-[#CF1322] font-normal">Sans commande</p>
                  </div>
                </div>
              </div>

              {/* AI Forecast */}
              <div className="col-span-4 bg-white p-6 rounded-lg border border-[#D9D9D9] flex flex-col gap-8">
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-2 text-[#1677FF]">
                    <TrendingUp size={24} />
                    <span className="text-[22.44px] font-medium uppercase">PRÉVISION IA</span>
                  </div>
                  <div className="flex items-center gap-2 px-2 py-2 bg-[#F6FFED] rounded text-[#389E0D]">
                    <CheckCircle2 size={24} />
                    <span className="text-xl font-semibold">Haute</span>
                  </div>
                </div>
                
                <div>
                  <div className="text-[48px] font-bold text-[#101828] leading-none">120</div>
                  <p className="text-xl text-black/45 mt-2">Unités recommandées</p>
                </div>

                <div className="grid grid-cols-3 gap-6">
                  <div className="bg-white p-2 rounded">
                    <p className="text-base text-black/65 mb-2">Ventes prévues</p>
                    <p className="text-[30px] font-semibold text-black">165</p>
                    <p className="text-[19.23px] text-[#389E0D] font-normal">+28% vs moy</p>
                  </div>
                  <div className="bg-white p-2 rounded">
                    <p className="text-base text-black/65 mb-2">Couverture</p>
                    <p className="text-[30px] font-semibold text-black">7J</p>
                    <p className="text-[19.23px] text-black/45 font-normal">avec commande</p>
                  </div>
                  <div className="bg-white p-2 rounded">
                    <p className="text-base text-black/65 mb-2">Risque</p>
                    <p className="text-[30px] font-semibold text-black">92%</p>
                    <p className="text-[19.23px] text-[#CF1322] font-normal">Sans commande</p>
                  </div>
                </div>
              </div>
              ...
              {/* Historical Data */}
              <div className="col-span-8 bg-white p-8 rounded-lg border border-[#D9D9D9] space-y-8">
                <h3 className="text-2xl font-semibold text-black/88">Données Historiques de Référence</h3>
                
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="text-left border-b border-[#D9D9D9]">
                        <th className="py-4 text-xl font-semibold text-black/65 uppercase">DATE</th>
                        <th className="py-4 text-xl font-semibold text-black/65 uppercase">CONTEXTE MÉTÉO</th>
                        <th className="py-4 text-xl font-semibold text-black/65 uppercase">PREVISIONS IA</th>
                        <th className="py-4 text-xl font-semibold text-black/65 uppercase">PREVISIONS INITIALES</th>
                        <th className="py-4 text-xl font-semibold text-black/65 uppercase">VENTES REALISÉES</th>
                        <th className="py-4 text-xl font-semibold text-black/65 uppercase">ÉCART DE PRÉCISION</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-50">
                      {[1, 2, 3].map((_, i) => (
                        <tr key={i}>
                          <td className="py-6 text-[22.44px] text-[#101828]">Juil 2025</td>
                          <td className="py-6">
                            <div className="flex items-center gap-2 text-black">
                              <Cloud size={25} className="text-black/45" />
                              <span className="text-[22.44px]">Meteo</span>
                            </div>
                          </td>
                          <td className="py-6 text-[22.44px] font-semibold text-black/88">165 unités</td>
                          <td className="py-6 text-[22.44px] font-semibold text-black/88">140 unités</td>
                          <td className="py-6 text-[22.44px] font-semibold text-black/88">162 unités</td>
                          <td className="py-6">
                            <span className="text-[22.44px] font-semibold text-[#0958D9]">IA (-3)</span>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                ...
                <div className="p-6 bg-[#F8FBFF] rounded-lg border border-[#91CAFF]">
                  <p className="text-[22.44px] text-[#1C398E] leading-relaxed">
                ...
                <div className="flex justify-center">
                  <button className="w-full py-4 bg-white border border-[#D9D9D9] rounded-lg text-xl text-black/65 hover:bg-slate-50 transition-colors shadow-sm">
                    Voir plus detail
                  </button>
                </div>
              </div>
              ...
              <div className="col-span-4">
                <div className="bg-white p-6 rounded-lg border border-[#E5E7EB] flex flex-col gap-6">
                  <h3 className="text-2xl font-semibold text-black/88">Votre Décision Finale</h3>
                  
                  <div className="flex items-baseline gap-4">
                    <span className="text-[48px] font-bold text-[#0958D9] leading-none">120</span>
                    <span className="text-xl text-black/45">unités</span>
                  </div>

                  <div className="space-y-3">
                    <label className="block text-xl text-[#364153]">Modifier les quantités Manuellement</label>
                    <div className="px-6 py-4 border border-[#D1D5DC] rounded bg-white text-[24px] font-semibold text-[#0A0A0A]">
                      120
                    </div>
                    <p className="text-[19.23px] text-[#6A7282]">Modify the AI recommendation if needed</p>
                  </div>

                  <button 
                    onClick={() => setState(prev => ({ ...prev, step: 'boutique-distribution' }))}
                    className="w-full py-4 bg-[#0958D9] text-white text-xl rounded hover:bg-blue-800 transition-all"
                  >
                    Valider et Répartir
                  </button>
                </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-[#F8FBFF]/30">
          ...
          <header className="bg-white border-b border-[#D9D9D9] px-6 py-8 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-6">
              <button 
                onClick={() => setState(prev => ({ ...prev, step: 'analysis-detail' }))}
                className="text-black hover:text-[#1677FF] transition-colors"
              >
                <ChevronLeft size={24} />
              </button>
              <div className="flex items-center gap-4">
                <img 
                  ...
                  alt="Product" 
                  className="w-[75px] h-[100px] object-cover"
                  referrerPolicy="no-referrer"
                />
                <div>
                  <h1 className="text-[38px] font-semibold leading-tight">Boutique Distribution</h1>
                  <p className="text-xl text-black/45">SKU: 859163YCUA21000     Jimmy Veste en laine et toile de soie</p>
                </div>
              </div>
            </div>
            <div className="text-right">
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="relative w-[532px]">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-black/45" size={24} />
                    <input 
                      type="text" 
                      placeholder="Recherche la boutique"
                      className="w-full pl-12 pr-10 py-2 border border-[#D9D9D9] rounded focus:outline-none"
                    />
                    <ChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 text-black/45" size={24} />
                  </div>
                  <button className="flex items-center gap-2 px-4 py-2 bg-[#F5F5F5] rounded text-sm">
                    <Filter size={24} className="text-black/88" />
                    <span>Filter</span>
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between border-b border-[#F0F0F0]">
                  <div className="flex items-center gap-8">
                    {['Tout les boutiques', 'Paris', 'Lille', 'Nice', 'Lyon'].map((tab, i) => (
                      <button 
                        key={tab}
                        className={`pb-4 text-sm font-semibold relative ${i === 0 ? 'text-[#0958D9]' : 'text-[#828282]'}`}
                      >
                        {tab}
                        {i === 0 && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#0958D9] rounded" />}
                      </button>
                    ))}
                    <button className="pb-4 text-sm text-[#828282] flex items-center gap-1">
                      <Plus size={12} />
                      Ajouter plus Tag
                    </button>
                  </div>
                  <div className="flex bg-[#F5F5F5] rounded p-1 mb-2">
                    <button className="p-2 bg-white rounded shadow-sm">
                      <Grid size={24} className="text-black/88" />
                    </button>
                    <button className="p-2 text-black/45">
                      <List size={24} />
                    </button>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                {BOUTIQUES.map((boutique, i) => (
                  <div key={i} className="bg-white p-6 rounded-lg border border-[#D9D9D9] space-y-4">
                    <div className="flex justify-between items-start">
                      <div className="flex gap-4">
                        <img 
                          src={boutique.img} 
                        ...
                        <div className="space-y-2">
                          <div>
                            <h4 className="text-2xl font-semibold text-[#101828]">{boutique.name}</h4>
                            <p className="text-base text-[#4A5565]">{boutique.type}</p>
                          </div>
                          <div className="bg-[#F8FBFF] border border-[#BAE0FF] rounded p-2">
                            <p className="text-base text-[#0958D9]">{boutique.tag}</p>
                          </div>
                        </div>
                      </div>
                      <div className="text-center">
                        <p className="text-[38px] font-semibold text-[#1677FF] leading-none">{boutique.units}</p>
                        <p className="text-base text-black/45">unités</p>
                      </div>
                    </div>

                    <div className="flex justify-between text-sm">
                      <div>
                        <p className="text-[#6A7282] mb-2">Avg Weekly Sales</p>
                        <p className="text-2xl font-semibold text-[#101828]">{boutique.avgSales}</p>
                        <p className="text-base text-black/45">unités</p>
                      </div>
                      <div>
                        <p className="text-[#6A7282] mb-2">Daily Foot Traffic</p>
                        <p className="text-2xl font-semibold text-[#101828]">{boutique.footTraffic}</p>
                        <p className="text-base text-black/45">perso</p>
                      </div>
                      <div>
                        <p className="text-[#6A7282] mb-2">Performance</p>
                        <p className="text-2xl font-semibold text-[#101828]">{boutique.performance}</p>
                        <p className="text-base text-black/45">sur 100</p>
                      </div>
                    </div>

                    <div className="space-y-2">
                      <div className="flex justify-between text-base text-[#4A5565]">
                        <span>Allocation %</span>
                        <span>{boutique.allocation}%</span>
                      </div>
                      <div className="h-[13px] bg-[#D9D9D9] rounded-full overflow-hidden">
                        <div 
              ...
              <div className="flex items-center justify-between py-10">
                <div className="flex items-center gap-2">
                  <span className="text-base text-black/88">Page Total：</span>
                  <div className="flex items-center gap-2 px-2 py-1 border border-[#D9D9D9] rounded">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <button className="p-2 text-black/45 disabled:opacity-50" disabled>
                      <ChevronLeft size={16} />
                    </button>
                    <button className="w-8 h-8 bg-[#F8FBFF] border border-[#BAE0FF] rounded text-[#1677FF] text-sm">1</button>
                    <button className="w-8 h-8 border border-[#D9D9D9] rounded text-black/88 text-sm">2</button>
                    <button className="w-8 h-8 border border-[#D9D9D9] rounded text-black/88 text-sm">3</button>
                    <button className="p-2 text-black/88">
                      <MoreHorizontal size={16} />
                    </button>
                    <button className="w-8 h-8 border border-[#D9D9D9] rounded text-black/88 text-sm">10</button>
                    <button className="p-2 text-[#111827]">
                      <ChevronRight size={16} />
                    </button>
                  </div>
                  <div className="flex items-center gap-2 bg-[#F5F5F5] p-1 rounded">
                    <div className="w-12 h-8 bg-white border border-[#D9D9D9] rounded flex items-center justify-center text-sm">10</div>
                    <span className="text-sm text-black/45">/20 Page</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-[503px] p-6 space-y-8 overflow-y-auto">
              {/* Finalisation et Export */}
              <div className="p-6 border border-[#D9D9D9] rounded space-y-8">
                <h3 className="text-2xl font-semibold text-black/88">Finalisation et Export</h3>
                <div className="space-y-4">
                  <button 
                    onClick={() => {
                    ...
                    className="w-full py-4 bg-[#0958D9] text-white rounded text-xl hover:bg-blue-700 transition-all flex items-center justify-center gap-3"
                  >
                  ...
                  <button 
                    ...
                    className="w-full py-4 bg-white border border-[#D9D9D9] text-black/65 rounded text-xl shadow-sm hover:bg-slate-50 transition-all"
                  >
                    Exporter en CSV
                  </button>
                  <button 
              ...
              {/* Bilan prévisionnel */}
              <div className="p-6 bg-[#F8FBFF] border border-[#BAE0FF] rounded-lg space-y-8">
                <h3 className="text-2xl font-semibold text-[#101828]">Bilan prévisionnel</h3>
                <div className="space-y-6">
                  <div className="flex justify-between items-center">
                    <span className="text-[22px] text-black/65">CA Prévu</span>
                    <span className="text-[25px] font-semibold text-black/88">€19,800</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[22px] text-black/65">Marge Bénéficiaire</span>
                    <span className="text-[25px] font-semibold text-[#237804]">+38%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[22px] text-black/65">Filabilité Stock</span>
                    <span className="text-[25px] font-semibold text-[#237804]">92%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[22px] text-black/65">Période de couverture</span>
                    <span className="text-[25px] font-semibold text-black/88">7 Jours</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between border-b border-slate-200 pb-4">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-sm">
                  <TrendingUp size={24} className="text-blue-50" />
                </div>
                <div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          ...
          >
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-[#0055ff] text-white font-semibold py-4 rounded-lg hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20 active:scale-[0.98]"
              >
                Se connecter
              </button>
        ...
        <div className="lg:col-span-5 flex flex-col gap-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <span className="font-bold text-sm mb-1">
                      {state.isConnectingErp ? 'Connexion...' : state.isErpConnected ? 'ERP Connecté' : 'Connecter ERP'}
                    </span>
          ...
          <section className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm flex flex-col flex-1">
            <div className="flex-1">
              <div className="flex items-center gap-2 text-[#0055ff] mb-6">
                <TrendingUp size={20} />
            ...
            <div className="mt-12">
              <button 
                ...
                className={`w-full py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 transition-all ${
                  isFormComplete 
                    ? "bg-[#0055ff] text-white shadow-lg shadow-blue-500/20 hover:bg-blue-700 active:scale-[0.98]" 
